$(document).ready(function() {
	...
	/*// Download
	$('#download-STL-button').click(function(e) {
		e.preventDefault();
		var url = 'edited-image.stl';
		var link = document.createElement("a");
		var path = 'D:\\Project - Tactile Diagrams\\MyWork\\FlaskProject\\files\\stl_files'+url;
		window.location.href = path;
		link.href = url;
		alert(url);
		link.download = 'my-stl.stl';
		link.click();
